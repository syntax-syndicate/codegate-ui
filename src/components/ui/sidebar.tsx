  ...
  (
    ...
    if (collapsible === "none") {
      return (
        <div
          className={twMerge(
            "flex h-full w-[--sidebar-width] flex-col bg-gray-25",
            className,
          )}
          ref={ref}
          {...props}
...
>(({ className, asChild = false, showOnHover = false, ...props }, ref) => {
  ...
  return (
    <Comp
      ...
      className={twMerge(
        "absolute right-1 top-1.5 flex aspect-square w-5 items-center justify-center rounded-md p-0 outline-none transition-transform hover:bg-gray-25 focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0",
...
>(({ className, ...props }, ref) => (
  <div
    ...
    className={twMerge(
      "absolute right-1 flex h-5 min-w-5 items-center justify-center rounded-md px-1 text-sm font-medium tabular-nums select-none pointer-events-none",
      "group-data-[collapsible=icon]:hidden",
      className,
    )}
    {...props}
