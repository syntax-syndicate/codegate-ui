  ...
  (
    ...
    return (
      <div
        ref={ref}
        className={twMerge(
          "grid min-w-32 items-start gap-1.5 rounded-lg border bg-base px-2.5 py-1.5 text-sm shadow-xl",
          className,
        )}
      >
                ...
                {formatter && item?.value !== undefined && item.name ? (
                  ...
                  <>
                    ...
                    >
                      ...
                      {item.value && (
                        <span className="font-code font-medium tabular-nums text-primary">
